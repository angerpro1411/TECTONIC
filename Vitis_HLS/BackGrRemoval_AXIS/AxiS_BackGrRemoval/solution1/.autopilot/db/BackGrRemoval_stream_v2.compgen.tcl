...
set name BackGrRemoval_stream_v2_mul_32s_32s_32_2_1
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 248 \
			corename BackGrRemoval_stream_v2_control_axilite \
			name BackGrRemoval_stream_v2_control_s_axi \
			ports {$port_control} \
			op interface \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler BackGrRemoval_stream_v2_control_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
# RegSlice definition:
set ID 263
set RegSliceName BackGrRemoval_stream_v2_regslice_both
set RegSliceInstName BackGrRemoval_stream_v2_regslice_both_U
set CoreName ap_simcore_BackGrRemoval_stream_v2_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
...
eval "::AESL_LIB_VIRTEX::xil_gen_regSlice { \
    name ${RegSliceName} \
    prefix BackGrRemoval_stream_v2_ \
    sliceTypeList 0\
}"
} else {
