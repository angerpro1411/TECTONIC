; ModuleID = '/home/dell3561-49/Vitis_HLS_folder/BaGrRe_AXIs_ver4/BaGrRe_AXIs/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_BackGrRemovalStream_ir(%"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"* noalias nonnull dereferenceable(12) %input_stream, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"* noalias nonnull dereferenceable(12) %output_stream) local_unnamed_addr #0 {
entry:
...
declare void @apatb_BackGrRemovalStream_hw(i24*, i3*, i3*, i1*, i1*, i1*, i1*, i24*, i3*, i3*, i1*, i1*, i1*, i1*)
...
define void @BackGrRemovalStream_hw_stub_wrapper(i24*, i3*, i3*, i1*, i1*, i1*, i1*, i24*, i3*, i3*, i1*, i1*, i1*, i1*) #5 {
entry:
  %14 = alloca %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"
  %15 = alloca %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"
  call void @copy_out(%"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"* %14, i24* %0, i3* %1, i3* %2, i1* %3, i1* %4, i1* %5, i1* %6, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"* %15, i24* %7, i3* %8, i3* %9, i1* %10, i1* %11, i1* %12, i1* %13)
  call void @BackGrRemovalStream_hw_stub(%"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"* %14, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"* %15)
  call void @copy_in(%"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"* %14, i24* %0, i3* %1, i3* %2, i1* %3, i1* %4, i1* %5, i1* %6, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"* %15, i24* %7, i3* %8, i3* %9, i1* %10, i1* %11, i1* %12, i1* %13)
  ret void
}

declare void @BackGrRemovalStream_hw_stub(%"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"*, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"*)
