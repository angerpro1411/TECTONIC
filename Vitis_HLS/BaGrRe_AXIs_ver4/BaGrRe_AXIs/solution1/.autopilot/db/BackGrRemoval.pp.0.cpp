...
{
#line 20 "/home/dell3561-49/Vitis_HLS_folder/BaGrRe_AXIs_ver4/BaGrRe_AXIs/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=BackGrRemovalStream
# 12 "BackGrRemoval.cpp"
...
#pragma HLS DATAFLOW
 ...
 static u8 h_line[11][320];
#pragma HLS ARRAY_PARTITION variable=h_line complete dim=1


 row_loop: for (u32 y = 0; y < 240; y++) {
        col_loop: for (u32 x = 0; x < 320; x++) {
#pragma HLS PIPELINE II=1
 ...
 AXI_VAL pixel_in = input_stream.read();
            ...
            VITIS_LOOP_51_1: for (u32 k = 0; k < 11 -1; k++) {
#pragma HLS UNROLL
 h_line[k][x] = h_line[k+1][x];
            ...
            kernel_loop: for (int i = 0; i < 11; i++) {
#pragma HLS UNROLL
 int yy = y + i - (11/2);
            ...
            pixel_out.strb = -1;
            pixel_out.user = 0;
            pixel_out.last = (y == 240 - 1 && x == 320 - 1);
            pixel_out.id = 0;
            pixel_out.dest = 0;
