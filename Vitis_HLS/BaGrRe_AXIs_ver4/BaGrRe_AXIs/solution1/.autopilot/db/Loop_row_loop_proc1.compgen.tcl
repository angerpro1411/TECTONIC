...
set name BackGrRemovalStream_sdiv_16ns_9ns_16_20_1
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler BackGrRemovalStream_Loop_row_loop_proc1_BackGrRemovalStream_stream_stream_axis_ap_uint_24_1ul_1ulbkb BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler BackGrRemovalStream_Loop_row_loop_proc1_BackGrRemovalStream_stream_stream_axis_ap_uint_24_1ul_1ulcud BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { output_stream_TREADY { I 1 bit } output_stream_TVALID { O 1 bit } output_stream_TDEST { O 1 vector } } \
} "
} else {
...
# RegSlice definition:
set ID 21
set RegSliceName BackGrRemovalStream_regslice_both
set RegSliceInstName BackGrRemovalStream_regslice_both_U
set CoreName ap_simcore_BackGrRemovalStream_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
...
set InstName BackGrRemovalStream_flow_control_loop_pipe_U
set CompName BackGrRemovalStream_flow_control_loop_pipe
