...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "ContourApproximation.autotvin.dat"
	set constFileTvOut       "ContourApproximation.autotvout.dat"
	set constFileHdlTvIn     "ContourApproximation.autohdltvin.dat"
	set constFileHdlTvOut    "ContourApproximation.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
