...
$(ObjDir)/tb_contour.c_pre.c.tb.o : tb_contour.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) tb_contour.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/contour_approximation.c_pre.c.tb.o : contour_approximation.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) contour_approximation.c_pre.c.tb.c" $(AVE_DIR_DLOG)
