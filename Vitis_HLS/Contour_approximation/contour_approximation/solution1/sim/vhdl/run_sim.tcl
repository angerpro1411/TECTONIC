...
if {[file isfile ContourApproximation.autotvin.dat]} {
	file delete -force ContourApproximation.autotvin.dat
}

if {[file isfile ContourApproximation.autotvout.dat]} {
	file delete -force ContourApproximation.autotvout.dat
}
