# 1 "../../C_PROGRAM/3.ContourApproximation/contour_approximation.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 339 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../../C_PROGRAM/3.ContourApproximation/contour_approximation.c" 2
# 1 "/tools/Xilinx/Vitis_HLS/2023.1/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stdbool.h" 1 3
# 2 "../../C_PROGRAM/3.ContourApproximation/contour_approximation.c" 2
# 1 "../../C_PROGRAM/3.ContourApproximation/contour_approximation.h" 1
...
# 2 "../../C_PROGRAM/3.ContourApproximation/contour_approximation.h" 2
...
__attribute__((sdx_kernel("ContourApproximation", 0))) u16 ContourApproximation(u16 nb_pts, Points p[250],Points new_p[250], float espilon);

u16 PointNbReduction(u16 nb_pts , Points*p);
float Distance_Point_Line_Square(Points p,Lines l);
# 3 "../../C_PROGRAM/3.ContourApproximation/contour_approximation.c" 2
...
__attribute__((sdx_kernel("ContourApproximation", 0))) u16 ContourApproximation(u16 nb_pts, Points p[250],Points new_p[250], float espilon){
#line 18 "/home/dell3561-49/Vitis_HLS_folder/Contour_approximation/contour_approximation/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=ContourApproximation
# 55 "../../C_PROGRAM/3.ContourApproximation/contour_approximation.c"

#line 7 "/home/dell3561-49/Vitis_HLS_folder/Contour_approximation/contour_approximation/solution1/directives.tcl"
#pragma HLSDIRECTIVE TOP name=ContourApproximation
# 55 "../../C_PROGRAM/3.ContourApproximation/contour_approximation.c"
...
# 75 "../../C_PROGRAM/3.ContourApproximation/contour_approximation.c"
...
#pragma HLS UNROLL
 ...
 dist_square = Distance_Point_Line_Square(p[i],l);
   ...
   if(i+1 == nb_pts - 1){
    ...
    u16 newcnt = 0;
# 125 "../../C_PROGRAM/3.ContourApproximation/contour_approximation.c"
 WRITE_BACK:
 for(u16 i = 0; i < 250; ++i){
#pragma HLS PIPELINE
