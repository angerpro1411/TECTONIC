...
//------------------------Local signal-------------------
    ...
    wire [31:0]                   int_obj_is_green_q0;
    wire [2:0]                    int_obj_is_green_address1;
    wire                          int_obj_is_green_ce1;
    wire                          int_obj_is_green_we1;
    wire [3:0]                    int_obj_is_green_be1;
    wire [31:0]                   int_obj_is_green_d1;
    ...
    wire [31:0]                   int_obj_x_q0;
    wire [3:0]                    int_obj_x_address1;
    wire                          int_obj_x_ce1;
    wire                          int_obj_x_we1;
    wire [3:0]                    int_obj_x_be1;
    wire [31:0]                   int_obj_x_d1;
    ...
    wire [31:0]                   int_obj_y_q0;
    wire [3:0]                    int_obj_y_address1;
    wire                          int_obj_y_ce1;
    wire                          int_obj_y_we1;
    wire [3:0]                    int_obj_y_be1;
    wire [31:0]                   int_obj_y_d1;
...
assign obj_is_green_q0           = int_obj_is_green_q0 >> (int_obj_is_green_shift0 * 8);
...
assign int_obj_is_green_we1      = int_obj_is_green_write & w_hs;
assign int_obj_is_green_be1      = int_obj_is_green_we1 ? WSTRB : 'b0;
assign int_obj_is_green_d1       = WDATA;
// obj_x
...
assign obj_x_q0                  = int_obj_x_q0 >> (int_obj_x_shift0 * 16);
assign int_obj_x_address1        = ar_hs? raddr[5:2] : waddr[5:2];
assign int_obj_x_ce1             = ar_hs | (int_obj_x_write & WVALID);
assign int_obj_x_we1             = int_obj_x_write & w_hs;
assign int_obj_x_be1             = int_obj_x_we1 ? WSTRB : 'b0;
assign int_obj_x_d1              = WDATA;
// obj_y
...
assign obj_y_q0                  = int_obj_y_q0 >> (int_obj_y_shift0 * 16);
assign int_obj_y_address1        = ar_hs? raddr[5:2] : waddr[5:2];
assign int_obj_y_ce1             = ar_hs | (int_obj_y_write & WVALID);
assign int_obj_y_we1             = int_obj_y_write & w_hs;
assign int_obj_y_be1             = int_obj_y_we1 ? WSTRB : 'b0;
assign int_obj_y_d1              = WDATA;
...
// int_obj_is_green_write
always @(posedge ACLK) begin
    if (ARESET)
        int_obj_is_green_write <= 1'b0;
    else if (ACLK_EN) begin
        if (aw_hs && AWADDR[ADDR_BITS-1:0] >= ADDR_OBJ_IS_GREEN_BASE && AWADDR[ADDR_BITS-1:0] <= ADDR_OBJ_IS_GREEN_HIGH)
            int_obj_is_green_write <= 1'b1;
        else if (w_hs)
            int_obj_is_green_write <= 1'b0;
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        int_obj_x_write <= 1'b0;
    else if (ACLK_EN) begin
        if (aw_hs && AWADDR[ADDR_BITS-1:0] >= ADDR_OBJ_X_BASE && AWADDR[ADDR_BITS-1:0] <= ADDR_OBJ_X_HIGH)
            int_obj_x_write <= 1'b1;
        else if (w_hs)
            int_obj_x_write <= 1'b0;
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        int_obj_y_write <= 1'b0;
    else if (ACLK_EN) begin
        if (aw_hs && AWADDR[ADDR_BITS-1:0] >= ADDR_OBJ_Y_BASE && AWADDR[ADDR_BITS-1:0] <= ADDR_OBJ_Y_HIGH)
            int_obj_y_write <= 1'b1;
        else if (w_hs)
            int_obj_y_write <= 1'b0;
    end
end
