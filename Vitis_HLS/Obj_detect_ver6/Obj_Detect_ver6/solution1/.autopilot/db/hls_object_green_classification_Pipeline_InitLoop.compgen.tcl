...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename parent \
    op interface \
    ports { parent_address1 { O 9 vector } parent_ce1 { O 1 bit } parent_we1 { O 1 bit } parent_d1 { O 16 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename min_x \
    op interface \
    ports { min_x_address1 { O 9 vector } min_x_ce1 { O 1 bit } min_x_we1 { O 1 bit } min_x_d1 { O 9 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename max_x \
    op interface \
    ports { max_x_address1 { O 9 vector } max_x_ce1 { O 1 bit } max_x_we1 { O 1 bit } max_x_d1 { O 9 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename min_y \
    op interface \
    ports { min_y_address1 { O 9 vector } min_y_ce1 { O 1 bit } min_y_we1 { O 1 bit } min_y_d1 { O 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename max_y \
    op interface \
    ports { max_y_address1 { O 9 vector } max_y_ce1 { O 1 bit } max_y_we1 { O 1 bit } max_y_d1 { O 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { center_is_green_address0 { O 9 vector } center_is_green_ce0 { O 1 bit } center_is_green_we0 { O 1 bit } center_is_green_d0 { O 1 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir O \
    corename pixel_count \
    op interface \
    ports { pixel_count_address1 { O 9 vector } pixel_count_ce1 { O 1 bit } pixel_count_we1 { O 1 bit } pixel_count_d1 { O 16 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'pixel_count'"
}
}
