set moduleName hls_object_green_classification_Pipeline_VITIS_LOOP_276_5
set isTopModule 0
...
set C_modelName {hls_object_green_classification_Pipeline_VITIS_LOOP_276_5}
set C_modelType { void 0 }
set C_modelArgList {
	{ count_reload int 16 regular  }
	{ obj_x int 16 regular {array 32 { 1 } 1 1 }  }
	{ obj_y int 16 regular {array 32 { 1 } 1 1 }  }
	{ obj_is_green int 1 regular {array 32 { 1 } 1 1 }  }
	{ obj_x_buf int 16 regular {array 32 { 0 3 } 0 1 } {global 1}  }
	{ obj_y_buf int 16 regular {array 32 { 0 3 } 0 1 } {global 1}  }
	{ obj_is_green_buf int 1 regular {array 32 { 0 3 } 0 1 } {global 1}  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "count_reload", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "obj_x", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "obj_y", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "obj_is_green", "interface" : "memory", "bitwidth" : 1, "direction" : "READONLY"} , 
 	{ "Name" : "obj_x_buf", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY", "extern" : 0} , 
 	{ "Name" : "obj_y_buf", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY", "extern" : 0} , 
 	{ "Name" : "obj_is_green_buf", "interface" : "memory", "bitwidth" : 1, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "obj_x_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "obj_x", "role": "q0" }} , 
 	...
 	{ "name": "obj_y_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "obj_y", "role": "q0" }} , 
 	...
 	{ "name": "obj_is_green_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "obj_is_green", "role": "q0" }} , 
 	...
 	{ "name": "obj_x_buf_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "obj_x_buf", "role": "we0" }} , 
 	{ "name": "obj_x_buf_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "obj_x_buf", "role": "d0" }} , 
 	...
 	{ "name": "obj_y_buf_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "obj_y_buf", "role": "we0" }} , 
 	{ "name": "obj_y_buf_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "obj_y_buf", "role": "d0" }} , 
 	...
 	{ "name": "obj_is_green_buf_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "obj_is_green_buf", "role": "we0" }} , 
 	{ "name": "obj_is_green_buf_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "obj_is_green_buf", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	...
	obj_x { ap_memory {  { obj_x_address0 mem_address 1 5 }  { obj_x_ce0 mem_ce 1 1 }  { obj_x_q0 in_data 0 16 } } }
	obj_y { ap_memory {  { obj_y_address0 mem_address 1 5 }  { obj_y_ce0 mem_ce 1 1 }  { obj_y_q0 in_data 0 16 } } }
	obj_is_green { ap_memory {  { obj_is_green_address0 mem_address 1 5 }  { obj_is_green_ce0 mem_ce 1 1 }  { obj_is_green_q0 in_data 0 1 } } }
	obj_x_buf { ap_memory {  { obj_x_buf_address0 mem_address 1 5 }  { obj_x_buf_ce0 mem_ce 1 1 }  { obj_x_buf_we0 mem_we 1 1 }  { obj_x_buf_d0 mem_din 1 16 } } }
	obj_y_buf { ap_memory {  { obj_y_buf_address0 mem_address 1 5 }  { obj_y_buf_ce0 mem_ce 1 1 }  { obj_y_buf_we0 mem_we 1 1 }  { obj_y_buf_d0 mem_din 1 16 } } }
	obj_is_green_buf { ap_memory {  { obj_is_green_buf_address0 mem_address 1 5 }  { obj_is_green_buf_ce0 mem_ce 1 1 }  { obj_is_green_buf_we0 mem_we 1 1 }  { obj_is_green_buf_d0 mem_din 1 1 } } }
}
