set moduleName hls_object_green_classification_Pipeline_VITIS_LOOP_218_3_VITIS_LOOP_219_4
set isTopModule 0
...
set C_modelName {hls_object_green_classification_Pipeline_VITIS_LOOP_218_3_VITIS_LOOP_219_4}
set C_modelType { void 0 }
set C_modelArgList {
	{ label_map int 16 regular {array 76800 { 1 3 } 1 1 } {global 0}  }
	{ pixel_count int 16 regular {array 512 { 1 0 } 1 1 } {global 2}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "label_map", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "pixel_count", "interface" : "memory", "bitwidth" : 16, "direction" : "READWRITE", "extern" : 0} , 
...
set portList { 
	...
	{ pixel_count_address0 sc_out sc_lv 9 signal 1 } 
	{ pixel_count_ce0 sc_out sc_logic 1 signal 1 } 
	{ pixel_count_q0 sc_in sc_lv 16 signal 1 } 
	{ pixel_count_address1 sc_out sc_lv 9 signal 1 } 
	{ pixel_count_ce1 sc_out sc_logic 1 signal 1 } 
	{ pixel_count_we1 sc_out sc_logic 1 signal 1 } 
	{ pixel_count_d1 sc_out sc_lv 16 signal 1 } 
	{ max_y_address0 sc_out sc_lv 9 signal 2 } 
	{ max_y_ce0 sc_out sc_logic 1 signal 2 } 
	{ max_y_q0 sc_in sc_lv 8 signal 2 } 
	{ max_y_address1 sc_out sc_lv 9 signal 2 } 
	{ max_y_ce1 sc_out sc_logic 1 signal 2 } 
	{ max_y_we1 sc_out sc_logic 1 signal 2 } 
	{ max_y_d1 sc_out sc_lv 8 signal 2 } 
	{ min_y_address0 sc_out sc_lv 9 signal 3 } 
	{ min_y_ce0 sc_out sc_logic 1 signal 3 } 
	{ min_y_q0 sc_in sc_lv 8 signal 3 } 
	...
	{ max_x_address0 sc_out sc_lv 9 signal 4 } 
	{ max_x_ce0 sc_out sc_logic 1 signal 4 } 
	{ max_x_q0 sc_in sc_lv 9 signal 4 } 
	{ max_x_address1 sc_out sc_lv 9 signal 4 } 
	{ max_x_ce1 sc_out sc_logic 1 signal 4 } 
	{ max_x_we1 sc_out sc_logic 1 signal 4 } 
	{ max_x_d1 sc_out sc_lv 9 signal 4 } 
...
set Spec2ImplPortList { 
	...
	pixel_count { ap_memory {  { pixel_count_address0 mem_address 1 9 }  { pixel_count_ce0 mem_ce 1 1 }  { pixel_count_q0 in_data 0 16 }  { pixel_count_address1 MemPortADDR2 1 9 }  { pixel_count_ce1 MemPortCE2 1 1 }  { pixel_count_we1 MemPortWE2 1 1 }  { pixel_count_d1 MemPortDIN2 1 16 } } }
