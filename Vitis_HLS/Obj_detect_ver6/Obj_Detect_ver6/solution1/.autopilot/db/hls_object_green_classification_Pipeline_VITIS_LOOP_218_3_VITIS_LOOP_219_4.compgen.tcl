...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { pixel_count_address0 { O 9 vector } pixel_count_ce0 { O 1 bit } pixel_count_q0 { I 16 vector } pixel_count_address1 { O 9 vector } pixel_count_ce1 { O 1 bit } pixel_count_we1 { O 1 bit } pixel_count_d1 { O 16 vector } } \
} "
} else {
