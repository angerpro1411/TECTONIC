...
HLS_SOURCES = ../../../../tb.cpp ../../../../contourDetect.cpp
...
$(ObjDir)/contourDetect.o: ../../../../contourDetect.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../contourDetect.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/contourDetect.d
