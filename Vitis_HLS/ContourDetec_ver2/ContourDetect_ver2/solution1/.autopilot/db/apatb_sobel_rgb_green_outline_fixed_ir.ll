; ModuleID = '/home/dell3561-49/Vitis_HLS_folder/ContourDetec_ver2/ContourDetect_ver2/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_sobel_rgb_green_outline_fixed_ir(%"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"* noalias nonnull dereferenceable(12) %in_stream, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"* noalias nonnull dereferenceable(12) %out_stream) local_unnamed_addr #0 {
entry:
...
declare void @apatb_sobel_rgb_green_outline_fixed_hw(i24*, i3*, i3*, i1*, i1*, i1*, i1*, i24*, i3*, i3*, i1*, i1*, i1*, i1*)
...
define void @sobel_rgb_green_outline_fixed_hw_stub_wrapper(i24*, i3*, i3*, i1*, i1*, i1*, i1*, i24*, i3*, i3*, i1*, i1*, i1*, i1*) #5 {
entry:
  ...
  call void @sobel_rgb_green_outline_fixed_hw_stub(%"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"* %14, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"* %15)
...
declare void @sobel_rgb_green_outline_fixed_hw_stub(%"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"*, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"*)
