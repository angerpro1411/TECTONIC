...
set name sobel_rgb_green_outline_fixed_mul_41ns_43ns_56_3_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {mul} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}


set name sobel_rgb_green_outline_fixed_mul_8ns_7ns_14_1_1
if {${::AESL::PGuard_rtl_comp_handler}} {
...
set id 3
set name sobel_rgb_green_outline_fixed_mux_2_1_8_1_1
...
set name sobel_rgb_green_outline_fixed_mul_11s_11s_21_1_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {mul} IMPL {auto} LATENCY 0 ALLOW_PRAGMA 1
}
...
set id 6
set name sobel_rgb_green_outline_fixed_mac_muladd_8ns_4ns_14ns_41_4_1
...
set ce_signed 0
set out_width 41
set arg_lists {i0 {8 0 +} i1 {4 0 +} m {12 0 +} i2 {14 0 +} p {41 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_rtl_comp_handler}} {
...
set id 7
set name sobel_rgb_green_outline_fixed_mac_muladd_11s_11s_21s_21_4_1
set corename simcore_mac
set op mac
set stage_num 4
set clk_width 1
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler sobel_rgb_green_outline_fixed_sobel_rgb_green_outline_fixed_stream_stream_axis_0_linebuf_1_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
# RegSlice definition:
set ID 29
set RegSliceName sobel_rgb_green_outline_fixed_regslice_both
set RegSliceInstName sobel_rgb_green_outline_fixed_regslice_both_U
set CoreName ap_simcore_sobel_rgb_green_outline_fixed_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
...
eval "::AESL_LIB_VIRTEX::xil_gen_regSlice { \
    name ${RegSliceName} \
    prefix sobel_rgb_green_outline_fixed_ \
    sliceTypeList 0\
}"
} else {
...
set InstName sobel_rgb_green_outline_fixed_flow_control_loop_pipe_no_ap_cont_U
set CompName sobel_rgb_green_outline_fixed_flow_control_loop_pipe_no_ap_cont
