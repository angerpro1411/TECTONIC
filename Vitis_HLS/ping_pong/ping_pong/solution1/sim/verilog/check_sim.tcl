...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.algo.autotvin_vecIn_0.dat"
         "c.algo.autotvin_vecIn_1.dat"
         "c.algo.autotvin_vecOut_0.dat"
         "c.algo.autotvin_vecOut_1.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.algo.autotvout_vecOut_0.dat"
         "rtl.algo.autotvout_vecOut_1.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
