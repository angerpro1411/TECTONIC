...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "algo.autotvin.dat"
	set constFileTvOut       "algo.autotvout.dat"
	set constFileHdlTvIn     "algo.autohdltvin.dat"
	set constFileHdlTvOut    "algo.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
