...
#define AUTOTB_TVOUT_vecIn_0 "../tv/cdatafile/c.algo.autotvout_vecIn_0.dat"
#define AUTOTB_TVIN_vecIn_1 "../tv/cdatafile/c.algo.autotvin_vecIn_1.dat"
#define AUTOTB_TVOUT_vecIn_1 "../tv/cdatafile/c.algo.autotvout_vecIn_1.dat"
...
// tvout file define:
#define AUTOTB_TVOUT_PC_vecOut_0 "../tv/rtldatafile/rtl.algo.autotvout_vecOut_0.dat"
#define AUTOTB_TVOUT_PC_vecOut_1 "../tv/rtldatafile/rtl.algo.autotvout_vecOut_1.dat"
...
extern "C"
void algo_hw_stub_wrapper(void*, void*, void*, void*);

extern "C"
void apatb_algo_hw(void* __xlx_apatb_param_vecIn_0, void* __xlx_apatb_param_vecIn_1, void* __xlx_apatb_param_vecOut_0, void* __xlx_apatb_param_vecOut_1)
{
#ifdef USE_BINARY_TV_FILE
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port0 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_vecIn_0),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_vecIn_0),
#endif
#endif
  };
  port0.param = { __xlx_apatb_param_vecIn_0 };
  port0.nbytes = { 50 };
  port0.offset = {  };
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port1 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_vecIn_1),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_vecIn_1),
#endif
#endif
  };
  port1.param = { __xlx_apatb_param_vecIn_1 };
  port1.nbytes = { 50 };
  port1.offset = {  };
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_vecOut_0),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_vecOut_0),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_vecOut_0),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_vecOut_0),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_vecOut_0),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_vecOut_0),
#endif
#endif
  };
  port2.param = { __xlx_apatb_param_vecOut_0 };
  port2.nbytes = { 50 };
  port2.offset = {  };
  port2.hasWrite = { true };
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_vecOut_1),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_vecOut_1),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_vecOut_1),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_vecOut_1),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_vecOut_1),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_vecOut_1),
#endif
#endif
  };
  port3.param = { __xlx_apatb_param_vecOut_1 };
  port3.nbytes = { 50 };
  port3.offset = {  };
  port3.hasWrite = { true };
  ...
  try {
    ...
    algo_hw_stub_wrapper(__xlx_apatb_param_vecIn_0, __xlx_apatb_param_vecIn_1, __xlx_apatb_param_vecOut_0, __xlx_apatb_param_vecOut_1);
