set moduleName algo_Pipeline_DIVISION_LOOP
set isTopModule 0
...
set C_modelName {algo_Pipeline_DIVISION_LOOP}
set C_modelType { void 0 }
set C_modelArgList {
	{ vecOut_0 int 8 regular {array 50 { 0 3 } 0 1 }  }
	{ d int 5 regular {array 100 { 1 3 } 1 1 }  }
	{ c int 3 regular {array 100 { 1 3 } 1 1 }  }
	{ vecOut_1 int 8 regular {array 50 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "vecOut_0", "interface" : "memory", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	{ "Name" : "d", "interface" : "memory", "bitwidth" : 5, "direction" : "READONLY"} , 
 	{ "Name" : "c", "interface" : "memory", "bitwidth" : 3, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ vecOut_0_address0 sc_out sc_lv 6 signal 0 } 
	{ vecOut_0_ce0 sc_out sc_logic 1 signal 0 } 
	{ vecOut_0_we0 sc_out sc_logic 1 signal 0 } 
	{ vecOut_0_d0 sc_out sc_lv 8 signal 0 } 
	{ d_address0 sc_out sc_lv 7 signal 1 } 
	{ d_ce0 sc_out sc_logic 1 signal 1 } 
	{ d_q0 sc_in sc_lv 5 signal 1 } 
	{ c_address0 sc_out sc_lv 7 signal 2 } 
	{ c_ce0 sc_out sc_logic 1 signal 2 } 
	{ c_q0 sc_in sc_lv 3 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "d_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "d", "role": "q0" }} , 
 	{ "name": "c_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "c", "role": "address0" }} , 
 	{ "name": "c_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "c", "role": "ce0" }} , 
 	{ "name": "c_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "c", "role": "q0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.udiv_5ns_3ns_5_9_1_U13", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	d { ap_memory {  { d_address0 mem_address 1 7 }  { d_ce0 mem_ce 1 1 }  { d_q0 in_data 0 5 } } }
	c { ap_memory {  { c_address0 mem_address 1 7 }  { c_ce0 mem_ce 1 1 }  { c_q0 in_data 0 3 } } }
