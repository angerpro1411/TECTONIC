set moduleName algo_Pipeline_REMAINDER_LOOP
set isTopModule 0
...
set C_modelName {algo_Pipeline_REMAINDER_LOOP}
set C_modelType { void 0 }
set C_modelArgList {
	{ vecIn_0 int 8 regular {array 50 { 1 3 } 1 1 }  }
	{ vecIn_1 int 8 regular {array 50 { 1 3 } 1 1 }  }
	{ a int 2 regular {array 100 { 0 3 } 0 1 }  }
	{ b int 4 regular {array 100 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "vecIn_0", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "a", "interface" : "memory", "bitwidth" : 2, "direction" : "WRITEONLY"} , 
 	{ "Name" : "b", "interface" : "memory", "bitwidth" : 4, "direction" : "WRITEONLY"} ]}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "a_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "a", "role": "d0" }} , 
 	...
 	{ "name": "b_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "b", "role": "d0" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_2_1_8_1_1_U1", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.urem_8ns_5ns_4_12_1_U2", "Parent" : "0"},
...
set Spec2ImplPortList { 
	vecIn_0 { ap_memory {  { vecIn_0_address0 mem_address 1 6 }  { vecIn_0_ce0 mem_ce 1 1 }  { vecIn_0_q0 in_data 0 8 } } }
	vecIn_1 { ap_memory {  { vecIn_1_address0 mem_address 1 6 }  { vecIn_1_ce0 mem_ce 1 1 }  { vecIn_1_q0 in_data 0 8 } } }
	a { ap_memory {  { a_address0 mem_address 1 7 }  { a_ce0 mem_ce 1 1 }  { a_we0 mem_we 1 1 }  { a_d0 mem_din 1 2 } } }
	b { ap_memory {  { b_address0 mem_address 1 7 }  { b_ce0 mem_ce 1 1 }  { b_we0 mem_we 1 1 }  { b_d0 mem_din 1 4 } } }
}
