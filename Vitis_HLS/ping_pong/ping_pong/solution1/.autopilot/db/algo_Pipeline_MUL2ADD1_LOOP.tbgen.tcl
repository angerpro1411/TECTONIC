set moduleName algo_Pipeline_MUL2ADD1_LOOP
set isTopModule 0
...
set C_modelName {algo_Pipeline_MUL2ADD1_LOOP}
set C_modelType { void 0 }
set C_modelArgList {
	{ b int 4 regular {array 100 { 1 3 } 1 1 }  }
	{ d int 5 regular {array 100 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "b", "interface" : "memory", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "d", "interface" : "memory", "bitwidth" : 5, "direction" : "WRITEONLY"} ]}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "d_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "d", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	b { ap_memory {  { b_address0 mem_address 1 7 }  { b_ce0 mem_ce 1 1 }  { b_q0 in_data 0 4 } } }
	d { ap_memory {  { d_address0 mem_address 1 7 }  { d_ce0 mem_ce 1 1 }  { d_we0 mem_we 1 1 }  { d_d0 mem_din 1 5 } } }
}
