...
//
//#pragma HLS INTERFACE ap_none    port=irq_frame_done     // <-- real interrupt pin
//#pragma HLS INTERFACE s_axilite port=irq_clear bundle=CTRL
//
...
//	    if(parent[i]==i && is_external[i]) {  // only external
...
//
//	// If CPU clears interrupt (irq_clear = 1), drop the signal
//	if(irq_clear == 1)
//	    irq_frame_done = 0;
//	else
//	    irq_frame_done = 1;  // Raise interrupt for CPU
//
//}
