...
#pragma HLS INLINE
 ap_uint<16> root = x;
 VITIS_LOOP_349_1: while(parent[root] != root) root = parent[root];
 ap_uint<16> cur = x;
 VITIS_LOOP_351_2: while(parent[cur] != root) {
...
#line 19 "/home/dell3561-49/Vitis_HLS_folder/Obj_detect_ver5/Obj_detect_ver5/solution1/csynth.tcl"
...
#pragma HLS UNROLL
 ...
 VITIS_LOOP_525_1: for (int y=0; y<240; y++) {
     VITIS_LOOP_526_2: for (int x=0; x<320; x++) {
#pragma HLS PIPELINE II=3
 ...
 VITIS_LOOP_537_3: for (int y=0; y<240; y++) {
     VITIS_LOOP_538_4: for (int x=0; x<320; x++) {
#pragma HLS PIPELINE II=3
 ap_uint<16> lbl = label_map[y][x];
         if (lbl != 0) {
...
#pragma HLS PIPELINE II=2
 ...
 VITIS_LOOP_592_5: for(int k=0; k<count; k++) {
#pragma HLS PIPELINE II=1
 obj_x_buf[k] = obj_x[k];
     obj_y_buf[k] = obj_y[k];
...
#pragma HLS PIPELINE II=1
 ...
 VITIS_LOOP_626_6: for(int k=0; k<object_count_buf; k++) {
#pragma HLS PIPELINE II=1
 obj_x[k] = obj_x_buf[k];
     obj_y[k] = obj_y_buf[k];
