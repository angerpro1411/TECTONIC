...
using hls::sim::Byte;
extern "C" char MeanShiftFiltering(volatile void *, volatile void *, int, int, char, char, char);
extern "C" char apatb_MeanShiftFiltering_hw(volatile void * __xlx_apatb_param_in_r, volatile void * __xlx_apatb_param_out_r, int __xlx_apatb_param_ImageWidth, int __xlx_apatb_param_ImageHeight, char __xlx_apatb_param_sd, char __xlx_apatb_param_cd, char __xlx_apatb_param_max_iter) {
using hls::sim::createStream;
  // DUT call
  char ap_return = MeanShiftFiltering(__xlx_apatb_param_in_r, __xlx_apatb_param_out_r, __xlx_apatb_param_ImageWidth, __xlx_apatb_param_ImageHeight, __xlx_apatb_param_sd, __xlx_apatb_param_cd, __xlx_apatb_param_max_iter);
return ap_return;
}
