# 1 "../MeanShiftFilter/MeanShiftFilter.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../MeanShiftFilter/MeanShiftFilter.cpp" 2
# 1 "../MeanShiftFilter/MeanShiftFilter.h" 1
...
# 2 "../MeanShiftFilter/MeanShiftFilter.h" 2
# 1 "/tools/Xilinx/Vitis_HLS/2023.1/common/technology/autopilot/ap_int.h" 1
# 3 "../MeanShiftFilter/MeanShiftFilter.h" 2
# 15 "../MeanShiftFilter/MeanShiftFilter.h"
...
__attribute__((sdx_kernel("MeanShiftFiltering", 0))) void MeanShiftFiltering(Pixel* in,Pixel* out,u32 ImageWidth,
    u32 ImageHeight, u8 sd, u8 cd, u8 max_iter);
# 2 "../MeanShiftFilter/MeanShiftFilter.cpp" 2

__attribute__((sdx_kernel("MeanShiftFiltering", 0))) void MeanShiftFiltering(Pixel* in,Pixel* out,u32 ImageWidth,
    u32 ImageHeight, u8 sd, u8 cd, u8 max_iter){
#line 18 "/home/dell3561-49/Vitis_HLS_folder/NewMeanShift/MeanShiftFilter/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=MeanShiftFiltering
# 4 "../MeanShiftFilter/MeanShiftFilter.cpp"
