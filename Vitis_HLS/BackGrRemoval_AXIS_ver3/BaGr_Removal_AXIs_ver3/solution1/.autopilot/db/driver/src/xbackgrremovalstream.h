...
// 
// ==============================================================
#ifndef XBACKGRREMOVALSTREAM_H
#define XBACKGRREMOVALSTREAM_H
...
#include <stddef.h>
#endif
#include "xbackgrremovalstream_hw.h"
...
} XBackgrremovalstream_Config;
#endif

typedef struct {
    u64 Control_BaseAddress;
    u32 IsReady;
} XBackgrremovalstream;

typedef u32 word_type;

/***************** Macros (Inline Functions) Definitions *********************/
#ifndef __linux__
#define XBackgrremovalstream_WriteReg(BaseAddress, RegOffset, Data) \
    Xil_Out32((BaseAddress) + (RegOffset), (u32)(Data))
#define XBackgrremovalstream_ReadReg(BaseAddress, RegOffset) \
