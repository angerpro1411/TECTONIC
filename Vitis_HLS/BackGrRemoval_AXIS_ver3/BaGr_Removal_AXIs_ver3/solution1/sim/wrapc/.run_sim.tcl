...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "BackGrRemovalStream.autotvin.dat"
	set constFileTvOut       "BackGrRemovalStream.autotvout.dat"
	set constFileHdlTvIn     "BackGrRemovalStream.autohdltvin.dat"
	set constFileHdlTvOut    "BackGrRemovalStream.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
