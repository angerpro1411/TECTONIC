...
$(ObjDir)/BackGrRemoval.cpp_pre.cpp.tb.o : BackGrRemoval.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling BackGrRemoval.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/RGB2HSV.cpp_pre.cpp.tb.o : RGB2HSV.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling RGB2HSV.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \
