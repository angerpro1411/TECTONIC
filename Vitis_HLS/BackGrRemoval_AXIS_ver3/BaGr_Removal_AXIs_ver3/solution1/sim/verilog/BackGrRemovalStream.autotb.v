...
`define AUTOTB_DUT      BackGrRemovalStream
`define AUTOTB_DUT_INST AESL_inst_BackGrRemovalStream
`define AUTOTB_TOP      apatb_BackGrRemovalStream_top
`define AUTOTB_LAT_RESULT_FILE "BackGrRemovalStream.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "BackGrRemovalStream.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_BackGrRemovalStream_top
...
`define AUTOTB_TVIN_input_stream_V_data_V_out_wrapc  "../tv/rtldatafile/rtl.BackGrRemovalStream.autotvin_input_stream_V_data_V.dat"
`define AUTOTB_TVIN_input_stream_V_keep_V_out_wrapc  "../tv/rtldatafile/rtl.BackGrRemovalStream.autotvin_input_stream_V_keep_V.dat"
`define AUTOTB_TVIN_input_stream_V_strb_V_out_wrapc  "../tv/rtldatafile/rtl.BackGrRemovalStream.autotvin_input_stream_V_strb_V.dat"
`define AUTOTB_TVIN_input_stream_V_user_V_out_wrapc  "../tv/rtldatafile/rtl.BackGrRemovalStream.autotvin_input_stream_V_user_V.dat"
`define AUTOTB_TVIN_input_stream_V_last_V_out_wrapc  "../tv/rtldatafile/rtl.BackGrRemovalStream.autotvin_input_stream_V_last_V.dat"
`define AUTOTB_TVIN_input_stream_V_id_V_out_wrapc  "../tv/rtldatafile/rtl.BackGrRemovalStream.autotvin_input_stream_V_id_V.dat"
`define AUTOTB_TVIN_input_stream_V_dest_V_out_wrapc  "../tv/rtldatafile/rtl.BackGrRemovalStream.autotvin_input_stream_V_dest_V.dat"
`define AUTOTB_TVIN_threshold_out_wrapc  "../tv/rtldatafile/rtl.BackGrRemovalStream.autotvin_threshold.dat"
...
`define AUTOTB_TVOUT_output_stream_V_data_V_out_wrapc  "../tv/rtldatafile/rtl.BackGrRemovalStream.autotvout_output_stream_V_data_V.dat"
`define AUTOTB_TVOUT_output_stream_V_keep_V_out_wrapc  "../tv/rtldatafile/rtl.BackGrRemovalStream.autotvout_output_stream_V_keep_V.dat"
`define AUTOTB_TVOUT_output_stream_V_strb_V_out_wrapc  "../tv/rtldatafile/rtl.BackGrRemovalStream.autotvout_output_stream_V_strb_V.dat"
`define AUTOTB_TVOUT_output_stream_V_user_V_out_wrapc  "../tv/rtldatafile/rtl.BackGrRemovalStream.autotvout_output_stream_V_user_V.dat"
`define AUTOTB_TVOUT_output_stream_V_last_V_out_wrapc  "../tv/rtldatafile/rtl.BackGrRemovalStream.autotvout_output_stream_V_last_V.dat"
`define AUTOTB_TVOUT_output_stream_V_id_V_out_wrapc  "../tv/rtldatafile/rtl.BackGrRemovalStream.autotvout_output_stream_V_id_V.dat"
`define AUTOTB_TVOUT_output_stream_V_dest_V_out_wrapc  "../tv/rtldatafile/rtl.BackGrRemovalStream.autotvout_output_stream_V_dest_V.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 76825;
parameter LENGTH_input_stream_V_data_V = 76800;
parameter LENGTH_input_stream_V_dest_V = 76800;
parameter LENGTH_input_stream_V_id_V = 76800;
parameter LENGTH_input_stream_V_keep_V = 76800;
parameter LENGTH_input_stream_V_last_V = 76800;
parameter LENGTH_input_stream_V_strb_V = 76800;
parameter LENGTH_input_stream_V_user_V = 76800;
parameter LENGTH_output_stream_V_data_V = 76800;
parameter LENGTH_output_stream_V_dest_V = 76800;
parameter LENGTH_output_stream_V_id_V = 76800;
parameter LENGTH_output_stream_V_keep_V = 76800;
parameter LENGTH_output_stream_V_last_V = 76800;
parameter LENGTH_output_stream_V_strb_V = 76800;
parameter LENGTH_output_stream_V_user_V = 76800;
