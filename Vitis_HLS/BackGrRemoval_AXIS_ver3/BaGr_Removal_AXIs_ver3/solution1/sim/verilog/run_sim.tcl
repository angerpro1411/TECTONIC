...
if {[file isfile BackGrRemovalStream.autotvin.dat]} {
	file delete -force BackGrRemovalStream.autotvin.dat
}

if {[file isfile BackGrRemovalStream.autotvout.dat]} {
	file delete -force BackGrRemovalStream.autotvout.dat
}
