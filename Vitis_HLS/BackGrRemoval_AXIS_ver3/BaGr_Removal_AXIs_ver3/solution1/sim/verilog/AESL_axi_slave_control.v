...
//------------------------Parameter----------------------
`define TV_IN_threshold "../tv/cdatafile/c.BackGrRemovalStream.autotvin_threshold.dat"
...
parameter BackGrRemovalStream_continue_addr = 0;
parameter BackGrRemovalStream_auto_start_addr = 0;
...
assign TRAN_control_write_data_finish = 1 & threshold_write_data_finish;
        ...
        if (ongoing_process_number === process_num && process_busy === 0 ) begin
            ...
            if (write_threshold_run_flag === 1 && get_ack === 1) begin
                ...
                for (i = 0 ; i < four_byte_num ; i = i+1) begin
                    ...
                    write (threshold_data_in_addr + write_threshold_count * ceil_align_to_pow_of_two_four_byte_num * 4 + i * 4, threshold_data_tmp_reg, write_threshold_resp);
