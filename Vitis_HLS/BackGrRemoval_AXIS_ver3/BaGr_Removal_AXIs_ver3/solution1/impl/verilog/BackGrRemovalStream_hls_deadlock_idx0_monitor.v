...
module BackGrRemovalStream_hls_deadlock_idx0_monitor ( // for module BackGrRemovalStream_BackGrRemovalStream_inst
    input wire clock,
    input wire reset,
...
// instant sub module
 BackGrRemovalStream_hls_deadlock_idx1_monitor BackGrRemovalStream_hls_deadlock_idx1_monitor_U (
    .clock(clock),
    .reset(reset),
