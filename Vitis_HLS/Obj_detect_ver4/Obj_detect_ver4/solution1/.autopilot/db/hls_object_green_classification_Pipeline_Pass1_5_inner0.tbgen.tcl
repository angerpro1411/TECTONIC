...
set C_modelArgList {
	{ tmp int 1 regular  }
	{ mul_ln207 int 14 regular  }
	{ empty int 14 regular  }
	{ mul_ln207_1 int 14 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "tmp", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	{ "Name" : "mul_ln207", "interface" : "wire", "bitwidth" : 14, "direction" : "READONLY"} , 
 	{ "Name" : "empty", "interface" : "wire", "bitwidth" : 14, "direction" : "READONLY"} , 
 	{ "Name" : "mul_ln207_1", "interface" : "wire", "bitwidth" : 14, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ mul_ln207 sc_in sc_lv 14 signal 1 } 
	{ empty sc_in sc_lv 14 signal 2 } 
	{ mul_ln207_1 sc_in sc_lv 14 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "mul_ln207", "direction": "in", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "mul_ln207", "role": "default" }} , 
 	{ "name": "empty", "direction": "in", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "empty", "role": "default" }} , 
 	{ "name": "mul_ln207_1", "direction": "in", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "mul_ln207_1", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	mul_ln207 { ap_none {  { mul_ln207 in_data 0 14 } } }
	empty { ap_none {  { empty in_data 0 14 } } }
	mul_ln207_1 { ap_none {  { mul_ln207_1 in_data 0 14 } } }
