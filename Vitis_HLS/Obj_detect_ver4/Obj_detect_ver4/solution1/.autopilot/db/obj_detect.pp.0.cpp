...
#pragma HLS INLINE
 ap_uint<16> root = x;
 VITIS_LOOP_25_1: while(parent[root] != root) root = parent[root];
 ap_uint<16> cur = x;
 VITIS_LOOP_27_2: while(parent[cur] != root) {
...
#line 17 "/home/dell3561-49/Vitis_HLS_folder/Obj_detect_ver4/Obj_detect_ver4/solution1/csynth.tcl"
...
#pragma HLS UNROLL
 ...
 VITIS_LOOP_223_1: for (int y=0; y<240; y++) {
     VITIS_LOOP_224_2: for (int x=0; x<320; x++) {
#pragma HLS PIPELINE II=3
 ...
 VITIS_LOOP_235_3: for (int y=0; y<240; y++) {
     VITIS_LOOP_236_4: for (int x=0; x<320; x++) {
#pragma HLS PIPELINE II=3
 ap_uint<16> lbl = label_map[y][x];
         if (lbl != 0) {
