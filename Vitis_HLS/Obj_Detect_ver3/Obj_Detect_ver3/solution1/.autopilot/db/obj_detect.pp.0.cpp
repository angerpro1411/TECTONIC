...
#pragma HLS INLINE
 ap_uint<16> root = x;
 VITIS_LOOP_24_1: while(parent[root] != root) root = parent[root];
 ap_uint<16> cur = x;
 VITIS_LOOP_26_2: while(parent[cur] != root) {
...
#line 17 "/home/dell3561-49/Vitis_HLS_folder/Obj_Detect_ver3/Obj_Detect_ver3/solution1/csynth.tcl"
...
#pragma HLS PIPELINE II=1
 ...
 Pass3_outer: for(int y=0;y<240;y++){
  Pass3_inner:for(int x=0;x<320;x++){
