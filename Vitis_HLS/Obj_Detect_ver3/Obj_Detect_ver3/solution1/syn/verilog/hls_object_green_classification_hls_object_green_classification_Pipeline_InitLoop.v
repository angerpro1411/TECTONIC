...
wire   [8:0] trunc_ln112_fu_195_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
        if ((icmp_ln109_fu_173_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((icmp_ln109_fu_173_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln109_fu_173_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
...
assign center_is_green_address1 = zext_ln109_fu_185_p1;

assign center_is_green_d1 = 1'd0;

assign i_5_fu_179_p2 = (ap_sig_allocacmp_i_4 + 10'd1);

assign icmp_ln109_fu_173_p2 = ((ap_sig_allocacmp_i_4 == 10'd512) ? 1'b1 : 1'b0);

assign max_x_address1 = zext_ln109_fu_185_p1;

assign max_x_d1 = 9'd0;

assign max_y_address1 = zext_ln109_fu_185_p1;

assign max_y_d1 = 8'd0;

assign min_x_address1 = zext_ln109_fu_185_p1;

assign min_x_d1 = 9'd320;

assign min_y_address1 = zext_ln109_fu_185_p1;

assign min_y_d1 = 8'd240;

assign parent_address1 = zext_ln109_fu_185_p1;

assign parent_d1 = trunc_ln112_fu_195_p1;

assign trunc_ln112_fu_195_p1 = ap_sig_allocacmp_i_4[8:0];

assign zext_ln109_fu_185_p1 = ap_sig_allocacmp_i_4;
