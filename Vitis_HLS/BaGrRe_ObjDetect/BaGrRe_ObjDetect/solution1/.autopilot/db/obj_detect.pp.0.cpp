...
#pragma HLS UNROLL
 ...
 VITIS_LOOP_201_1: for (int y=0; y<240; y++) {
     VITIS_LOOP_202_2: for (int x=0; x<320; x++) {
#pragma HLS PIPELINE II=3
 ...
 VITIS_LOOP_213_3: for (int y=0; y<240; y++) {
     VITIS_LOOP_214_4: for (int x=0; x<320; x++) {
#pragma HLS PIPELINE II=3
 ap_uint<16> lbl = label_map[y][x];
         if (lbl != 0) {
...
#pragma HLS PIPELINE II=2
 ...
 VITIS_LOOP_268_5: for(int k=0; k<count; k++) {
#pragma HLS PIPELINE II=1
 obj_x_buf[k] = obj_x[k];
     obj_y_buf[k] = obj_y[k];
...
#pragma HLS PIPELINE II=1
 ...
 VITIS_LOOP_302_6: for(int k=0; k<object_count_buf; k++) {
#pragma HLS PIPELINE II=1
 obj_x[k] = obj_x_buf[k];
     obj_y[k] = obj_y_buf[k];
