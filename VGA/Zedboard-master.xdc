...
# VGA Output - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y21  [get_ports {o_RGB_DATA[8]}];  # "VGA-B1"
set_property PACKAGE_PIN Y20  [get_ports {o_RGB_DATA[9]}];  # "VGA-B2"
set_property PACKAGE_PIN AB20 [get_ports {o_RGB_DATA[10]}];  # "VGA-B3"
set_property PACKAGE_PIN AB19 [get_ports {o_RGB_DATA[11]}];  # "VGA-B4"
set_property PACKAGE_PIN AB22 [get_ports {o_RGB_DATA[4]}];  # "VGA-G1"
set_property PACKAGE_PIN AA22 [get_ports {o_RGB_DATA[5]}];  # "VGA-G2"
set_property PACKAGE_PIN AB21 [get_ports {o_RGB_DATA[6]}];  # "VGA-G3"
set_property PACKAGE_PIN AA21 [get_ports {o_RGB_DATA[7]}];  # "VGA-G4"
set_property PACKAGE_PIN AA19 [get_ports {HSYNC}];  # "VGA-HS"
set_property PACKAGE_PIN V20  [get_ports {o_RGB_DATA[0]}];  # "VGA-R1"
set_property PACKAGE_PIN U20  [get_ports {o_RGB_DATA[1]}];  # "VGA-R2"
set_property PACKAGE_PIN V19  [get_ports {o_RGB_DATA[2]}];  # "VGA-R3"
set_property PACKAGE_PIN V18  [get_ports {o_RGB_DATA[3]}];  # "VGA-R4"
...
## ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN F22 [get_ports {i_RST_n}];  # "SW0"
set_property PACKAGE_PIN G22 [get_ports {SW[0]}];  # "SW1"
set_property PACKAGE_PIN H22 [get_ports {SW[1]}];  # "SW2"
set_property PACKAGE_PIN F21 [get_ports {SW[2]}];  # "SW3"
set_property PACKAGE_PIN H19 [get_ports {SW[3]}];  # "SW4"
set_property PACKAGE_PIN H18 [get_ports {SW[4]}];  # "SW5"
set_property PACKAGE_PIN H17 [get_ports {SW[5]}];  # "SW6"
set_property PACKAGE_PIN M15 [get_ports {SYNC_CLR}];  # "SW7"
